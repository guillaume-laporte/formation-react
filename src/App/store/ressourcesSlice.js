...
const ressourcesSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase('ressources/fetchRessources/fulfilled', (state, action) => {
        ...
        console.log("case ressources/fetchRessources/fulfilled");
    });
    ...
    builder.addDefaultCase(() => console.log('cas non pris en charge de déclenchement par asynThunk'));
  }
});

// export const {} = ressourcesSlice.actions

export const fetchAllRessources = createAsyncThunk('ressources/fetchRessources', async () => {
